...
describe('gulp-angular-embed-templates', function () {
    ...
    it('should use basePath to find the templates if specified', function (done) {
        ...
        sut = embedTemplates({ basePath: '/Users/alex4/git/gulp-angular-embed-templates/test' });
    ...
    it('should not skip errors if skipErrors not defined', function() {
        // TODO:
    });
    ...
    xit('should embed template when find pattern "templateUrl: string = \'path\'"', function (done) {
        testEmbed(
            './../test/cases/angular2-inheritance/inheritance-component.js',
            './../test/cases/angular2-inheritance/inheritance-embedded.js', done);
    });
});